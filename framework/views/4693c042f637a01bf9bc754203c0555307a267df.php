            ...
            <div class="col-6" style=" margin-left: 5%">
                <div class="row" style="display: flex;">
                    <div class="col-md-6">
                        ...
                        <div id="thongtin">
                            <input type="text" name="ten_khach_hang" value="<?php echo e($customer->ten_khach_hang); ?>" placeholder="Tên khách hàng" style="width: 500px; height: 40px;">
                        </div><br>
                        <div id="thongtin">
                            <input type="email" name="email" value="<?php echo e($customer->email); ?>" placeholder="Email" style="width: 500px; height: 40px;">
                        </div><br>
                        <div id="thongtin">
                            <input type="text" name="so_dien_thoai" value="<?php echo e($customer->so_dien_thoai); ?>" placeholder="Số điện thoại" style="width: 500px; height: 40px;">
                        </div><br>
                        <div id="thongtin">
                            <input type="text" name="dia_chi" value="<?php echo e($customer->dia_chi); ?>" placeholder="Địa chỉ" style="width: 500px; height: 40px;">
                        </div><br>
                        <div id="thongtin">
                    ...
                    <div class="item_discount" style="flex: 1 1 calc(33.333% - 16px); box-sizing: border-box; margin-bottom: 16px;">
                        <fieldset class="pro-discount" style="border: 1px solid #ccc !important; padding: 10px !important;">
                            ...
                            <div class="top_discount" style="margin-top: 10px !important;">
                                <div class="item-name">
                                    <p class="code_dis">
                                       Giảm <?php echo e($voucher->phan_tram_khuyen_mai); ?>%
                                    </p>
                                </div>
                            ...
                            <div class="coupon_desc" style="margin-top: 10px !important; height: 50px;">
                                <p><?php echo e($voucher->mo_ta); ?></p>        
                            </div>
                            <div class="copy_discount" style="margin-top: 10px !important;">
                                <p class="code_zip">
                                    Mã áp dụng:  <?php echo e($voucher->ma_ap_dung); ?>
            ...
            <div class="col-6" style="margin-left: 70px">
                        ...
                        <tr>
                            <td style="width: 100px;">
                                <div class="image-container" style="position: relative; width: 100px; height: 120px;">
                                    <img src="<?php echo e(asset('storage/images/' . $cart->productVariant->sanPham->hinhAnhs->first()->duong_dan)); ?>" alt="sanpham" style="width: 90px; height: 100px; object-fit: cover;">
                                </div>
                            </td>
                            <td style="padding-left: 10px;">
                                <div style="display: flex; flex-direction: column;">
                                    <div style="font-weight: bolder"><?php echo e($cart->productVariant->sanPham->ten_san_pham); ?></div>
                                    <div>Màu: <?php echo e($cart->productVariant->mau->mau); ?> / Kích thước: <?php echo e($cart->productVariant->kichThuoc->kich_thuoc); ?></div>
                                    <div>Số lượng: <?php echo e($cart->so_luong); ?></div>

                                </div>
                            </td>
                            <td style="text-align: right;"><?php echo e(number_format($cart->productVariant->sanPham->gia_ban * $cart->so_luong, 0, '.', '.')); ?> VNĐ</td>
                        </tr>
                    </table> 
                    <br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <div style="display: flex; justify-content: space-between; width: 590px;">
                        ...
                        <div id="subTotal">
                            <?php echo e(number_format($totalSum, 0, '.', '.')); ?> VNĐ
                        </div>
                    </div>
                    <br>
                    <div style="display: flex; justify-content: space-between; width: 590px;">
                    ...
                    <div id="discountAmount">
                        <?php echo e(number_format($discount, 0, '.', '.')); ?> VNĐ
                    </div>
                    <input id="discount" name="chiet_khau" type="text" value="<?php echo e(number_format($discount, 0, '.', '.')); ?>">
                    </div>
                    <hr style="width: 74%;">
                    <div style="display: flex; justify-content: space-between; width: 590px;">
                    <div>
                    ...
                    <div id="totalAmount">
                        <?php echo e(number_format($totalAfterDiscount, 0, '.', '.')); ?> VNĐ
                        
                    </div>
                    <input id="totalPricessInput" type="text" name="totalPricess" value="<?php echo e(number_format($totalAfterDiscount, 0, '.', '.')); ?>">
                    </div>
                <br>
...
<?php echo $__env->make('customer.maininterface', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\src_ThoiTrang\resources\views/customer/oderinter.blade.php ENDPATH**/ ?>