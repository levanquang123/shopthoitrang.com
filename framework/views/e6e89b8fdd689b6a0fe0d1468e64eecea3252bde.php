...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets')); ?>/cdn/shop/files/Black White Minimalist SImple Monogram Typography Logo (1)_preview_rev_1.png" />
    ...
    <?php endif; ?>
            ...
            <div class="crancy-wc__form-inner">
              <div class="crancy-wc__logo">
                <a href="index.html"><img src="<?php echo e(asset('assets')); ?>/cdn/shop/files/Black White Minimalist SImple Monogram Typography Logo (1)_preview_rev_1.png" alt="#" /></a>
              </div>
              <div class="crancy-wc__form-inside">
                <div class="crancy-wc__form-middle">
                  <div class="crancy-wc__form-top">
                    ...
                    <!-- Sign in Form -->
                    <form class="crancy-wc__form-main" id="postForm" action="<?php echo e(route('alogin')); ?>" method="post">
                      ...
                      <div class="form-group mg-top-30">
                        <a href="<?php echo e(route('index.signup')); ?>">Đăng ký tài khoản</a>
                      </div>
...
<?php /**PATH C:\laragon\www\src_ThoiTrang\resources\views/login/signin.blade.php ENDPATH**/ ?>