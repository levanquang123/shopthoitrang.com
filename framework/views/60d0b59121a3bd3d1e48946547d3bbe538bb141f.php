                ...
                <div class="crancy-table-meta mg-top-30">
                    ...
                    <div class="col-12">
                        ...
                        <div class="crancy-table-meta__group">
                            ...
                            <a href="<?php echo e(route('index.color')); ?>" class="crancy-btn crancy-btn__filter">
                            <svg
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="crancy-table crancy-table--v3 mg-top-30"  style="width: 1300px;">
                        ...
                        <div class="crancy-customer-filter__single crancy-customer-filter__search">
                            ...
                            <form class="crancy-header__form-inner" action="<?php echo e(route('search.color')); ?> " method="GET">
                        ...
                        <?php $__currentLoopData = $mausac; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td ><div class="crancy-wc__checkbox">
                                <input class="crancy-wc__form-check" type="checkbox" name="checkbox[]" value="<?php echo e($item->ma_mau); ?>" style="margin-left:20px;">
                                <span><?php echo e($item->ma_mau); ?></span>
                            </div></td>
                            <td><?php echo e($item->mau); ?></td>
                            <td>  <span style="display: inline-block; width: 100px; height: 20px; background-color: <?php echo e($item->ma_mau_chi_tiet); ?>;"></span>
                                </td>
                            <td>
                                <a href="<?php echo e(route('edit.color', ['ma_mau' => $item->ma_mau])); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i>Edit</a>
                                <a href="<?php echo e(route('delete.color', ['ma_mau' => $item->ma_mau])); ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>Delete</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('administrators.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\src_ThoiTrang\resources\views/administrators/list/color.blade.php ENDPATH**/ ?>