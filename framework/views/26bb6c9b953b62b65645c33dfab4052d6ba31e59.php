                ...
                <div class="crancy-table-meta mg-top-30">
                    ...
                    <div class="col-12">
                        ...
                        <div class="crancy-table-meta__group">
                            ...
                            <a href="<?php echo e(route('index.sale')); ?>" class="crancy-btn crancy-btn__filter">
                            <svg
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="crancy-table crancy-table--v3 mg-top-30">
                        ...
                        <thead class="crancy-table__head">
                            ...
                            <?php $__currentLoopData = $khuyenmai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="margin-left:70px ">
                                    <td ><div class="crancy-wc__checkbox">
                                        <input class="crancy-wc__form-check" type="checkbox" name="checkbox[]" value="<?php echo e($item->ma_khuyen_mai); ?>" style="margin-left:20px;">
                                        <span><?php echo e($item->ma_khuyen_mai); ?></span>
                                    </div></td>
                                    <td ><div style="margin-left:25px;"><?php echo e($item->phan_tram_khuyen_mai); ?></div></td>
                                    <td ><div style="margin-left:25px;">từ <?php echo e(number_format($item->gia_ap_dung,0,'.','.')); ?> VNĐ trở lên</div></td>
                                    <td><div style="margin-left:25px;">
                                        <?php echo e($item->mo_ta); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('edit.sale', ['ma_khuyen_mai' => $item->ma_khuyen_mai])); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i>Sửa</a>
                                        <a href="<?php echo e(route('delete.sale', ['ma_khuyen_mai' => $item->ma_khuyen_mai])); ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>Xóa</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('administrators.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\src_ThoiTrang\resources\views/administrators/list/sale.blade.php ENDPATH**/ ?>